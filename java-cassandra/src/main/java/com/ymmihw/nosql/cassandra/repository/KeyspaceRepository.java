...
public class KeyspaceRepository {
   ...
   * 
   */
  public void createKeyspace(String keyspaceName, String replicatioonStrategy,
  ...
  /**
   * Method used to delete the specified schema. It results in the immediate, irreversable removal
   * of the keyspace, including all tables and data contained in the keyspace.
   * 
